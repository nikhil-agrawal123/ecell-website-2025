      ...
      <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
          <figure className="max-w-screen-md mx-auto">
              ...
              <blockquote>
                  ...
                  &quot;Your success is our purpose. At C.S. Bhatiya & Associates, we don&apos;t just deliver services—we build partnerships that drive growth, ensure compliance, and create lasting value.&quot;</p>
              </blockquote>
              <figcaption className="flex items-center justify-center mt-6 space-x-3">
                  <img className="w-12 h-12 rounded-full " src="/logo.png" alt="profile picture"></img>
                  <div className="flex items-center divide-x-2 divide-gray-500 dark:divide-gray-700">
                      <div className="pr-3 font-medium text-gray-900 dark:text-white"> CA. Chintan S. Bhatiya 
                      (FCA, B.com, ICAI-GST, DISA)</div>
          ...
          <figure className="max-w-screen-md mx-auto">
              ...
              <figcaption className="flex items-center justify-center mt-6 space-x-3">
                  ...
                  <div className="flex items-center divide-x-2 divide-gray-200">
                      <div className="pr-3 font-medium text-white"> CA. Chintan S. Bhatiya 
                      (FCA, B.com, ICAI-GST, DISA)</div>
